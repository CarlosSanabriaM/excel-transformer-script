...
def transform_excel(transform_strategy, input_file, output_file, start_column_name, count_column_name):
    ...
    # Use the given strategy to transform the sheet
    transform_strategy.transform_excel_sheet(sheet, start_column_index, count_column_name)
...
if __name__ == "__main__":
    # Update these values
    transform_strategy_name = 'RELATIVE'  # Replace with your desired strategy
    ...
    transform_strategy = STRATEGIES_MAP.get(transform_strategy_name)
